...
function EducationCard({img,Course,College,Duration}) {
  return (
    <div className='flex flex-col md:flex-row bg-indigo-400 text-gray-900 md:w-full w-4/5 md:items-center mx-auto mt-10 rounded-lg overflow-hidden drop-shadow-xl'>
